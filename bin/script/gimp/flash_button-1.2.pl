...
my ($cfg_file, $width, $height, $text, $filenamestem, $fixed_width,
    ...
    $fontsize, $fontfoundry, $fontname, $fontweight, $fontslant, $fontwidth, 
    $fontspacing, $fontregistry, $fontencoding, $image_dir);
...
sub produce_images {
	...
	my $textlayer = gimp_text ($image, $backlayer, 0, 0, $text, 0, 1, 
				   $fontsize, PIXELS, $fontfoundry, $fontname, $fontweight, 
...
sub create_image {
    ...
    gimp_hue_saturation ($backlayer, 0, 0, 100, 0) if $off_img;
