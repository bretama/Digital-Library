...
_textdescrlogout_ [l=kn] {_cgiargunHtmlsafe_ ಎಂಬ ಹೆಸರಿನಲ್ಲಿ ಹೊರಗೆ ಬನ್ನಿ}  
...
_linktextLOGGEDIN_ [l=kn] {( _cgiargunHtmlsafe_ ಎಂಬ ಹೆಸರಿನಲ್ಲಿ ಪ್ರವೇಶಿಸಿದ್ದಾಗಿದೆ)}  
...
ಈ ಪ್ರಶ್ನೆಗೆ: _cgiargqHtmlsafe_,ಈ ಪ್ರಶ್ನೆಗೆ ಸರಿಯಾದ ಹೊಂದಾಣಿಕೆಗಳಿಲ್ಲ: _cgiargqHtmlsafe_)}  
