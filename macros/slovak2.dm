...
_textextlinkcontent_ [l=sk] {Vyznačený odkaz je externý. Ak ho chcete zobraziť, môžete ísť<a href="_nexturl_" onClick="follow\_escaped\_link(event, this.href">dopredu</a> na túto stránku. Pre návrat k predchádzajúcemu dokumentu použite tlačidlo "späť" vo vašom prehliadači. }
...
<p>Zvolený odkaz pre zbierku "_collectionname_" je externý (smeruje do zbierky "_2_"). Ak chcete zobraziť tento odkaz v zbierke "_2_" môžete kliknúť<a href="_httpdoc_&c=_1_&cl=_cgiargclUrlsafe_&d=_3_">dopredu</a>na túto stránku. Pre návrat k predchádzajúcemu dokumentu použite tlačidlo "späť" vo vašom prehliadači.}
...
_textmustbelongtogroup_ [l=sk] {Pre prístup k tejto stránke musíte patriť k užívateľskej skupine "_cgiargugHtmlsafe_".}
...
_textdelperm_ [l=sk] {Zbierka _cgiargbc1dirnameHtmlsafe_ nemohla byť vymazaná. Pravdepodobné príčiny : <ul> <li> Greenstone nie je oprávnený vymazať priečinok _gsdlhome_/collect/_cgiargbc1dirnameHtmlsafe_.<br> Možno budete musieť priečinok zbierky _cgiargbc1dirnameHtmlsafe_ zmazať manuálne.</li><li>Greenstone nemôže spustiť program _gsdlhome_/bin/script/delcol.pl. Uistite sa, že súbor je možné čítať a spustiť.</li>
</ul>}

_textdelinv_ [l=sk] {Zbierka _cgiargbc1dirnameHtmlsafe_ je chránená, alebo nefunkčná. Vaša operácia bola zrušená. }

_textdelsuc_ [l=sk] {Zbierka _cgiargbc1dirnameHtmlsafe_ bola úspešne zmazaná.}

_textclonefail_ [l=sk] {Zbierka _cgiargclonecolHtmlsafe_ nemohla byť vyklonovaná. Možné príčiny :  <ul> <li> Zbierka _cgiargclonecolHtmlsafe_ neexistuje.<li> Zbierka _cgiargclonecolHtmlsafe_ nemá konfiguračný súbor collect.cfg <li> Greenstone nemá právo čítať súbor collect.cfg</ul>}
...
_textaboutpassword_ [l=sk] {Heslo musí byť dlhé 3 až 8 znakov a môže sa skladať zo znakov ASCII.}
...
_textremwarn_ [l=sk] {Ste si istý, že chcete zmazať používateľa <b>_cgiargumunHtmlsafe_</b>?}
...
_textgtigsinstaller_ [l=sk] {Greenstone inštalátor}
_textgtigs3colcfg_ [l=sk] {GS3 demo upraviť nastavenia}
