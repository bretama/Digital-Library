...
_textdescrdeposit_ [l=gu] {આઈટમને સંગ્રહમાં જમા કરો }
_textdescrlogin_ [l=gu] {લોગીન પાનું }
_textdescrlogout_ [l=gu] {_cgiargunHtmlsafe_ તરીકે લોગઆઉટ કરો }
...
_linktextDEPOSIT_ [l=gu] {જમા કરો }
_linktextLOGIN_ [l=gu] {લોગીન}
_linktextLOGGEDIN_ [l=gu] {(_cgiargunHtmlsafe_ તરીકે લોગીન કર્યું) }
...
_textdepositorlocal_ [l=gu] {નવી આઈટમને જમા કરવાનું શરુ કરો }
package gti
...
_textcommentusername_ [l=gu] {ઉપભોક્તાનું નામ }
_textaddusercomment_ [l=gu] {ટિપ્પણી ઉમેરો }
_textusercommentlogout_ [l=gu] {લોગ-આઉટ}
_textaddcomment_ [l=gu] {ટિપ્પણી મોકલો }
_textcommentsubmitted_ [l=gu] {ટિપ્પણી મોકલી }
_textisempty_ [l=gu] {કોઈ ટીપ્પણી નથી }
_textusercommentssection_ [l=gu] {ટિપ્પણી}
...
# any matches
_textquerytitle_ [l=gu] {_If_(_thislast_,results _thisfirst_ - _thislast_ ક્વેરી માટે: _cgiargqHtmlsafe_,ક્વેરી માટે મેચ થતુ નથી.: _cgiargqHtmlsafe_)}
...
_textsortbynone_ [l=gu] {ક્રમ બીલ્ડ કરો }
_textascending_ [l=gu] {ચઢતા}
_textdescending_ [l=gu] {ઉતરતા }
...
_textformcasefold_ [l=gu] {મુળાક્ષરો નાના છે કે મોટા તેવું ધ્યાનમાં ન લેશો}
_textformaccentfold_ [l=gu] {ઍક્સન્ટસ ને ધ્યાનમાં ન લો}
_textformstem_ [l=gu] {સ્ટેમ }
...
_textsqlformsearchtype_ [l=gu] {SQLએ _sqlformnumfieldoption_ ફિલ્ડ્સથી ઉમેરવામાં આવ્યું }
...
# html options
_textdoclayout_ [l=gu] {પ્રલેખ પૃષ્ઠની રચના:}
_textlayoutnavbar_ [l=gu] {ટોચ પર નેવિગેશન બાર }
_textlayoutnonavbar_ [l=gu] {કોઈ નેવિગેશન બાર નહિ }

_texttermhighlight_ [l=gu] {શોધ માટેના પદો હાય લાઈટ કરે છે:}
_texttermhighlighton_ [l=gu] {શોધ માટેના પદો હાય લાઈટ કરો}
_texttermhighlightoff_ [l=gu] {શોધ માટેના પદો હાય લાઈટ ન કરો}
