...
_textdescrlogout_ [l=vi] {Đăng nhập như _cgiargunHtmlsafe_}  
...
_linktextLOGGEDIN_ [l=vi] {(đăng nhập như _cgiargunHtmlsafe_)}  
...
# any matches
_textquerytitle_ [l=vi] {_If_(_thislast_,kết quả _thisfirst_ - _thislast_ cho câu truy vấn: _cgiargqHtmlsafe_,Không có kết quả khớp với câu truy vấn: _cgiargqHtmlsafe_)}
