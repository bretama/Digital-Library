...
_textdescrgreenstone_ [l=ti] {ዓብዪ ዓዲ ዲጂታል ላይብረሪ ሶፍትዌ}  
_textdescrusab_ [l=ti] {ንምጥቃም ዘሸገረካ/ኪ ነገር እንታይ እዩ?}  


# Metadata names and navigation bar labels

_textSearch_ [l=ti] {ድለ/ድለዪ}  
_labelSearch_ [l=ti] {ድለ/ድለዪ}  

# Dublin Core Metadata Element Set, Version 1.1
_textTitle_ [l=ti] {ኣርእስቲ}  
_labelTitle_ [l=ti] {ኣርእስቲ}  
_textCreator_ [l=ti] {ደራሲ}  
_labelCreator_ [l=ti] {ደራሲ}  
...
_textdescrSearch_ [l=ti] {ዝተወሰኑ ቃላት ድለ/ድለዪ}  
...
_nzdlpagefooter_ [l=ti] {<div class="divbar"> </div> <p><p><a href="#">Abiyi addi website</a>
...
# any matches
_textquerytitle_ [l=ti] {_If_(_thislast_፣ውፂት _thisfirst_ - _thislast_ ን፤ _cgiargqHtmlsafe_ መሕትት፣ ለ፤ _cgiargqHtmlsafe_ ነቲሕቶ ዝምዕማዕ  የለን )}  
