...
_textdescrlogout_ [l=ca] {Surt com _cgiargunHtmlsafe_}  
...
_linktextLOGGEDIN_ [l=ca] {(heu iniciat sessió com  _cgiargunHtmlsafe_)}  
...
# any matches
_textquerytitle_ [l=ca] {_If_(_thislast_,resultats _thisfirst_ - _thislast_ de la consulta: _cgiargqHtmlsafe_,No hi ha resultats pertinents per a la consulta: _cgiargqHtmlsafe_)}
