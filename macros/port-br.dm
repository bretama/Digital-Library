...
# any matches
_textquerytitle_ [l=pt-br] {_If_(_thislast_,resultados _thisfirst_ - _thislast_ para a consulta: _cgiargqHtmlsafe_,Nenhuma combinação encontrada para a consulta: _cgiargqHtmlsafe_)}  
