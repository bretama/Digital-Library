...
# any matches
_textquerytitle_ [l=id] {_If_(_thislast_,hasil _thisfirst_ - _thislast_ untuk pertanyaan: _cgiargqHtmlsafe_,Tidak ada yang memenuhi syarat: _cgiargqHtmlsafe_)}
