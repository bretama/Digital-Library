...
Сіз таңдаған сілтеме " _collectionname _ " жинаққа сыртқы болып табылады (ол " _2 _ " жинағымен байланысты). Егер сіз осы сілтеме арқылы  " _2 _ " жинағына өткіңіз келсе, онда сіз <a href="_httpdoc_&c=_1_&cl=_cgiargclUrlsafe_&d=_3_"> ары қарай мына бетке өтуіңізге болады </a>; басқаша алдынғы құжатқа оралу үшін сіздің браузеріңіздегі "back/артқа" батырмасын қолданыңыз. }
...
_textmustbelongtogroup_ [l=kk] {Назар аударыңыз, бұл параққа кіру үшін Сіз "_cgiargugHtmlsafe_" тобына жатуыңыз қажет.}
...
_textdelperm_ [l=kk] {<p> Кейбір бөліктер немесе барлық _cgiargbc1dirnameHtmlsafe_ Жинағы жойыла алмады. Мүмкін себептері:
<ul>
<li> Greenstone-ның gsdlhome_/collect/_cgiargbc1dirnameHtmlsafe_ директорийін жоюға рұқсат жоқ.
<br> Бұл каталогты өзіңіздің компьютеріңізден қолмен жасау режимінде жойып көріңіз. }

_textdelinv_ [l=kk] {_cgiargbc1dirnameHtmlsafe_  Жинағы қорғалған немесе зақымданған. Жою үрдісінен бас тартылды.}

_textdelsuc_ [l=kk] {_cgiargbc1dirnameHtmlsafe_  Жинағы сәтті жойылды.}

_textclonefail_ [l=kk] {_cgiargclonecolHtmlsafe_  Жинақ дубликатын жасау мүмкін емес. Мұның мүмкін себептері:
<ul>
<li> _cgiargclonecolHtmlsafe_  жинақтың жоқтығы
<li> _cgiargclonecolHtmlsafe_ жинақтың collect.cfg конфигурациялық файлдың жоқтығы
...
_textexptsuc_ [l=kk] {_cgiargbc1dirnameHtmlsafe_ Жинағы _gsdlhome_/tmp/exported\__cgiargbc1dirnameHtmlsafe_ директориясына сәтті енгізілді.}

_textexptfail_ [l=kk] {Жинақты экспорттауда жаңылу_cgiargbc1dirnameHtmlsafe_. 
...
_textremwarn_ [l=kk] {Сіз шыныменен қолданушы _cgiargumunHtmlsafe_ ді түпкілікті алып тастайсыз ба?}
...
_textgtigsinstaller_ [l=kk] {Greenstone жөндеу шебері}
