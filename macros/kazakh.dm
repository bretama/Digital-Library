...
_textdescrlogin_ [l=kk] {Кіру парағы}
_textdescrlogout_ [l=kk] {Жүйеден қалай шығу  _cgiargunHtmlsafe_}
...
_textAuthor_ [l=kk] {Автор}
_textAuthors_ [l=kk] {Авторлар}
...
_texticonogg_ [l=kk] {Ogg Vorbis құжатты қарау}
_texticonrmvideo_ [l=kk] {Real Media құжатты қарау}
...
_linktextLOGIN_ [l=kk] {кіру}
_linktextLOGGEDIN_ [l=kk] {(жүйеге қалай кіру _cgiargunHtmlsafe_)}
_linktextLOGOUT_ [l=kk] {шығу}
...
_textcommentusername_ [l=kk] {Қолданушының аты}
_textaddusercomment_ [l=kk] {Түсініңтемені еңгізу}
_textusercommentlogout_ [l=kk] {шығу}
_textaddcomment_ [l=kk] {Түсініктемені орналастыру}
_textcommentsubmitted_ [l=kk] {түсініктеме орналастарылды}
_textisempty_ [l=kk] {Түсініктеме бос күйінде болды}
_textusercommentssection_ [l=kk] {Түсініктемелер}
...
# any matches
_textquerytitle_ [l=kk] {_If_(_thislast_, _cgiargqHtmlsafe_ сұраным бойынша іздеудің нәтижелері: _thisfirst_ - _thislast_ , сұраным бойынша: _cgiargqHtmlsafe_ ештеңе табылған жоқ)}
...
_textascending_ [l=kk] {Артушы}
_textdescending_ [l=kk] {кемуші}
...
_textsqlformsearchtype_ [l=kk] {_sqlformnumfieldoption_ облыстармен SQL шығады}
...
_textbookoption_ [l=kk] {Кітапты қарап шығу тәптібі}
_textbookvieweron_ [l=kk] {іске қосу}
_textbookvieweroff_ [l=kk] {өшіру}

# html options
_textdoclayout_ [l=kk] {Құжат парғаның макеті:}
_textlayoutnavbar_ [l=kk] {САйтты басынан навигациялау}
_textlayoutnonavbar_ [l=kk] {Сайт навигациясын жою}

_texttermhighlighton_ [l=kk] {терминдерді іздеу бойынша белгілеу}
_texttermhighlightoff_ [l=kk] {белгіленген терминдер бойынша іздеу}
