...
_textdescrlogout_ [l=it] {Uscire come _cgiargunHtmlsafe_}  
...
_linktextLOGGEDIN_ [l=it] {(connesso come _cgiargunHtmlsafe_)}  
...
# any matches
_textquerytitle_ [l=it] {_If_(_thislast_,risultati _thisfirst_ - _thislast_ della ricerca: _cgiargqHtmlsafe_,Nessun risultato della ricerca: _cgiargqHtmlsafe_)}
