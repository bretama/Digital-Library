...
# any matches
_textquerytitle_ [l=gl] {_If_(_thislast_,resultados _thisfirst_ - _thislast_ para a consulta:_cgiargqHtmlsafe_,Non se atoparon resultados correspondentes á consulta: _cgiargqHtmlsafe_)}
