...
_httpview_ {_gwcgi_?a=p&p=about&c=_cgiargdi1dirnameUrlsafe_}
...
check the details before going to the next step.
 ...
 href="_httptmp_/_cgiargdi1tmpUrlsafe_/_cgiargdi1timestampUrlsafe_/_di1userfile_"
		...
		<script type="text/javascript">
		  ...
		  lookupext.innerHTML = text;
  	        ...
  	        <span id="pane1">
                  ...
                  <a href="javascript:add\_checksum('tmp/_cgiargdi1tmpJssafe_/_cgiargdi1timestampJssafe_/_di1userfile_')">calculate ...</a>
	        </span>
	      </td>
            </tr>
          </tbody>
...
you can verify.
    <input name="submit_show_checksums" value="Show checksums" 
         type="button" onClick="javascript:add\_checksum('tmp/_cgiargdi1tmpJssafe_/_cgiargdi1timestampJssafe_/_di1userfile_')"></li>
...
<script type="text/javascript">
 ...
 value="Correct one of these" onClick="javascript:check\_submit('step2')" type="button"> </td>
   ...
   href="_httptmp_/_cgiargdi1tmpUrlsafe_/_cgiargdi1timestampUrlsafe_/_cgiargdi1userfileUrlsafe_"
