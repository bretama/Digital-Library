...
_textdescrlogout_ [l=bn] {_cgiargunHtmlsafe_ হিসেবে লগআউট হয়েছে}  
...
_linktextLOGGEDIN_ [l=bn] {(_cgiargunHtmlsafe_ হিসেবে লগইন হয়েছে)}  
...
# any matches
_textquerytitle_ [l=bn] {_If_(_thislast_ফলাফল _thisfirst_ - _thislast_ প্রশ্নের জন্য _cgiargqHtmlsafe_,প্রশ্নের সাথে কোন কিছু মিলেছে নাঃ _cgiargqHtmlsafe_)}
