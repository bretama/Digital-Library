...
_textdescrlogout_ [l=fa] {خروج از سيستم به صورت  _cgiargunHtmlsafe_}
...
_linktextDEPOSIT_ [l=fa] {بیعانه}
_linktextLOGIN_ [l=fa] {ورود به سيستم}
_linktextLOGGEDIN_ [l=fa] {به عنوان _cgiargunHtmlsafe_ وارد سيستم شده است}
...
# any matches
_textquerytitle_ [l=fa] {_If_(_thislast_,results _thisfirst_ - _thislast_ for query: _cgiargqHtmlsafe_,تطابقی یافت نشد: _cgiargqHtmlsafe_)}
