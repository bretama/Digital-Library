...
_textdescrdeposit_ [l=es] {Depositar el item en la colección}
_textdescrlogin_ [l=es] {Página de ingreso}
_textdescrlogout_ [l=es] {Salir como _cgiargunHtmlsafe_}
...
_linktextDEPOSIT_ [l=es] {DEPOSITAR}
_linktextLOGIN_ [l=es] {INGRESAR}
_linktextLOGGEDIN_ [l=es] {(conectado como _cgiargunHtmlsafe_)}
...
_textdescrgogreenstone_ [l=es] {Le proporciona información sobre el software Greenstone y provee enlaces a información ampliada como colecciones de ejemplo, detalles técnicos y documentación.}
...
_textdescrcollector_ [l=es] {Permite crear colecciones online. Esto precede a la Interfaz de Bibliotecario,  para fines prácticos se recomienda usar esta última en lugar del Colector. }

package depositor

_textdepositor_ [l=es] {El Acumulador}
_textdescrdepositor_ [l=es] {Lo ayuda a agregar documentos a las colecciones online existentes, en vez de usar el GLI.}

_textdepositorlocal_ [l=es] {Comenzar nuevo depósito}
package gti
...
_textcommentusername_ [l=es] {Nombre de usuario}
_textaddusercomment_ [l=es] {Agregar comentario}
_textusercommentlogout_ [l=es] {Salir}
_textaddcomment_ [l=es] {enviar comentario}
_textcommentsubmitted_ [l=es] {Comentario Enviado}
_textisempty_ [l=es] {El comentario estaba vacío.}
_textusercommentssection_ [l=es] {Comentarios}
...
# any matches
_textquerytitle_ [l=es] {_If_(_thislast_,resultados _thisfirst_ - _thislast_ para la consulta:_cgiargqHtmlsafe_,No se encontraron resultados correspondientes a  la consulta: _cgiargqHtmlsafe_)}
...
_textsortbynone_ [l=es] {orden de construcción}
_textascending_ [l=es] {ascendente}
_textdescending_ [l=es] {descendente}
...
_textformcasefold_ [l=es] {ignorar mayúsculas}
_textformaccentfold_ [l=es] {ignorar acentos}
_textformstem_ [l=es] {palabra raíz}
