...
_httpcollection_ {_httpprefix_/collect/_cgiargcUrlsafe_}
...
_httppagedepositorcurrentcollection_{_gwcgi_?e=_compressedoptions_&amp;a=depositor&amp;c=_cgiargcUrlsafe_&amp;p=step1&amp;di1dirname=_cgiargcUrlsafe_&amp;di1buildtype=_getbuildtypestring_(_cgiargct_)&amp;di1local=1&amp;di1cache=_depositor:cacheoption_}

_getbuildtypestring_{_If_("_1_" eq "0",mg)_If_("_1_" eq "1",mgpp)_If_("_1_" eq "2",lucene)}
...
_httppagehome_ {_gwcgi_?a=p&amp;p=home&amp;l=_cgiarglUrlsafe_&amp;w=_cgiargwUrlsafe_}
...
_httpcurrentdocument_ {_gwcgi_?e=_compressedoptions_&amp;cl=_cgiargclUrlsafe_&amp;d=_cgiargdUrlsafe_}
