...
<a href="_httpdoc_&c=_1_&cl=_cgiargclUrlsafe_&d=_3_">go forward</a> ಮಾಡಿ; 
...
_textmustbelongtogroup_ [l=kn] {ಈ ಪುಟವನ್ನು ನೋಡಲು ನೀವು "_cgiargugHtmlsafe_" ಗುಂಪಿಗೆ ಸೇರಿದವರಾಗಿರಬೇಕು}  
...
_textdelperm_ [l=kn] {_cgiargbc1dirnameHtmlsafe_ ನ ಹಲವು ಅಥವಾ ಎಲ್ಲಾ ಸಂಗ್ರಹಗಳನ್ನು ತೆಗೆಯಲಾಗಲಿಲ್ಲ. ಇದಕ್ಕೆ ಕಾರಣಗಳು ಹೀಗಿರಬಹುದು:
<ul> 
<li> ಗ್ರೀನ್‌ಸ್ಟೋನ್‌ಗೆ  _gsdlhome_/collect/_cgiargbc1dirnameHtmlsafe_  ಡೈರಕ್ಟರಿಯನ್ನು ತೆಗೆಯಲು ಅನುಮತಿಯಿಲ್ಲ<br>
ನೀವು ನೇರವಾಗಿ ಈ ಡೈರಕ್ಟರಿಯನ್ನು ತೆಗೆದು,  _cgiargbc1dirnameHtmlsafe_ ಸಂಗ್ರಹವನ್ನು ತೆಗೆಯುವಕಾರ್ಯವನ್ನು ಪೂರ್ಣಗೊಳಿಸಿ. </li>
...
_textdelinv_ [l=kn] {_cgiargbc1dirnameHtmlsafe_ ಸಂಗ್ರಹ ರಕ್ಷಿಸಲ್ಪಟ್ಟಿದೆ ಅಥವಾ ಅದು ಸರಿಯಿಲ್ಲ.  ಹೀಗಾಗಿ ಸಂಗ್ರಹ ತೆಗೆಯುವ ಕಾರ್ಯ ರದ್ದಾಗಿದೆ.}  

_textdelsuc_ [l=kn] {_cgiargbc1dirnameHtmlsafe_ ಸಂಗ್ರಹವು ಸಫಲವಾಗಿ ತೆಗೆಯಲ್ಪಟ್ಟಿತು}  

_textclonefail_ [l=kn] {ಈ ಪುಟ ಪ್ರವೇಶಿಸಲು ಡಯಲ್
_cgiargclonecolHtmlsafe_ ಸಂಗ್ರಹವನ್ನು ಕ್ಲೋನ್ ಮಾಡಲಾಗಲಿಲ್ಲ. ಈ ಕೆಳಕಂಡ ಕಾರಣಗಳಿರಬಹುದು:
<ul>
<li>  _cgiargclonecolHtmlsafe_ ಸಂಗ್ರಹ ಅಸ್ತಿತ್ವದಲ್ಲಿಲ್ಲ 
<li> _cgiargclonecolHtmlsafe_ ಸಂಗ್ರಹಕ್ಕೆ ಬೇಕಾದ collect.cfg ಸಮಗ್ರಾಕೃತಿ ಕಡತವಿಲ್ಲ
...
_textexptsuc_ [l=kn] {_cgiargbc1dirnameHtmlsafe_ ಸಂಗ್ರಹವು ಸಫಲವಾಗಿ  _gsdlhome_/tmp/exported\__cgiargbc1dirnameHtmlsafe_ ಡೈರಕ್ಟರಿಗೆ ರಫ್ತಾಯಿತು}

_textexptfail_ [l=kn] {<p>_cgiargbc1dirnameHtmlsafe_ ಸಂಗ್ರಹದ ರಫ್ತು ಕಾರ್ಯ ವಿಫಲವಾಯಿತು.
...
_textaboutpassword_ [l=kn] {ಸಂಕೇತಪದಗಳ ಉದ್ದ 3ರಿಂದ 8 ಅಕ್ಷರಗಳ ಒಳಗಿರಬೇಕು. 
...
_textremwarn_ [l=kn] {<b>_cgiargumunHtmlsafe_</b> ಬಳಕೆದಾರರನ್ನು ನೀವು ನಿಜವಾಗಿ ಶಾಶ್ವತವಾಗಿ ತೆಗೆಯಲು ಇಚ್ಛಿಸುತ್ತೀರಾ?}  
