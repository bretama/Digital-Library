...
<input type=hidden name="e" value="_If_(_cgiarger_,_cgiargerAttrsafe_,_decodedcompressedoptionsAttrsafe_)">
_hiddenargs_
...
<td><input type="text" name="un" value="_cgiargunAttrsafe_" size=10></td>
<td></td></tr>
