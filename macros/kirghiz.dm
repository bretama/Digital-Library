...
# any matches
_textquerytitle_ [l=ky] {_If_(_thislast_, натыйжалары _thisfirst_ - _thislast_ суроо боюнча издөө: _cgiargqHtmlsafe_,суроо боюнча ылгоолор жок _cgiargqHtmlsafe_)}
