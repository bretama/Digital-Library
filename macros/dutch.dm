...
_textdescrdeposit_ [l=nl] {Neem het item op in de collectie}
_textdescrlogin_ [l=nl] {Login-pagina}
_textdescrlogout_ [l=nl] {Log uit als  _cgiargunHtmlsafe_}
...
_linktextDEPOSIT_ [l=nl] {opslag}
_linktextLOGIN_ [l=nl] {INLOGGEN }
_linktextLOGGEDIN_ [l=nl] {(ingelogd als  _cgiargunHtmlsafe_)}
...
_textdepositorlocal_ [l=nl] {Begin een nieuwe collectie}
package gti
...
_texticondetach_ [l=nl] {Open een nieuw venster voor deze pagina}
...
_textcommentusername_ [l=nl] {Gebruikersnaam}
_textaddusercomment_ [l=nl] {Voeg commentaar toe}
_textusercommentlogout_ [l=nl] {Log uit}
_textaddcomment_ [l=nl] {geef commentaar}
_textcommentsubmitted_ [l=nl] {Toegevoegd commentaar}
_textisempty_ [l=nl] {Commentaar was leeg}
_textusercommentssection_ [l=nl] {Commentaren}
...
# any matches
_textquerytitle_ [l=nl] {_If_(_thislast_, _thisfirst_ - _thislast_ resultaten voor de zoekactie: _cgiargqHtmlsafe_,geen resultaat voor de zoekactie: _cgiargqHtmlsafe_)}
...
_textsortbynone_ [l=nl] {ordening}
_textascending_ [l=nl] {oplopend}
_textdescending_ [l=nl] {afdalend}
...
_textformcasefold_ [l=nl] {Negeer hoofletters/ kleine letters}
_textformaccentfold_ [l=nl] {verwaarloos diakritische tekens}
_textformstem_ [l=nl] {woordstam}
...
_texthelpadvsearchmg_ [l=nl] {Geavanceerd zoeken in MG-collecties geeft twee opties, naar relevantie en booleaans.
...
<p>De resultaten kunnen naar <b>relevantie</b> geordend getoond worden, zoals voor de <b>sommige</b> zoekactie beschreven in <a href="\#query-type">_texthelpquerytypetitle_</a>, of in de "natuurlijke" (of "gebouwde") volgorde. Dit is de volgorde waarin de documenten verwerkt werden bij het opbouwen van de collectie.
<p>
...
sommige kenmerken van de interface aan Uw wensen aanpassen.
}
...
en titelindexen aanwezig kunnen zijn of hoofdstuk- en alinea-indexen. In het algemeen worden documenten die precies aan uw vraag voldoen
