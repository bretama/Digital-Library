...
<li>La colección _cgiargclonecolHtmlsafe_ no tiene ningún fichero collect.cfg
...
_texttokititle_ [l=es] {La hachuela que moldea la excelencia del pensamiento}
...
_textgtigs3colcfg_ [l=es] {Cadenas de collection-config de demostración.}
