...
_gtifind_ {
<h2><a href="_gwcgi_?a=gti&amp;p=lang&amp;e=_compressedoptions_">_gtitargetlanguagename_</a> -- <a href="_gwcgi_?a=gti&amp;p=core&amp;e=_compressedoptions_">_gtitranslationfiledescHtmlsafe_</a></h2>
<p>
_textgtienterquery_:
<p>
<nobr>
<input type="text" name="q" value="_cgiargqAttrsafe_" size="_gtitextareawidth_"/>
...
_gtioffline_ {
<h2><a href="_gwcgi_?a=gti&amp;p=lang&amp;e=_compressedoptions_">_gtitargetlanguagename_</a> -- _gtitranslationfiledescHtmlsafe_</h2>
<p>
...
# _If_(_gtiglihelpzipfilepath_ ne "", <a href="_httpprefix_/_gtiglihelpzipfilepathUrlsafe_">_textgtiglihelpzipfile_</a>,)<br>
...
<table border="0">
  ...
  _If_(_4_,<tr><td align="right">&nbsp;</td><td>
     ...
     _If_(_gtiglihelpzipfilepath_, <a href="_httpprefix_/_gtiglihelpzipfilepathUrlsafe_">_textgtiglihelpzipfile_</a>,)<br>

     <a href="_gwcgi_?a=gti&amp;p=offline&amp;e=_compressedoptions_">_textgtitranslatefileoffline_</a><br>
     _gtiviewtranslationfileinactionHtmlsafe_
  </td></tr>)
</table>
}


_gtiviewgs3interfaceinaction_ {It is not possible to view translations of the GS3 interface in action in a GS2 installation.}

_gtiviewgs3colcfginaction_ {It is not possible to view translations of the GS3 demo collections' config strings in action in a GS2 installation.}
...
<center>
  <table dir="_gtitextdirection_">
    ...
    <tr><td><textarea name="_cgiargtlcAttrsafe_::_1_" rows="_gtitextareaheight_" cols="_gtitextareawidth_">_2_</textarea></td></tr>
  </table>
</center>
}
...
<center>
  ...
  <table dir="_gtitextdirection_">
    ...
    <tr><td colspan="2"><textarea name="_cgiargtlcAttrsafe_::_1_" rows="_gtitextareaheight_" cols="_gtitextareawidth_"></textarea></td></tr>
  </table>
</center>
}
...
<center>
  ...
  <table dir="_gtitextdirection_">
    ...
    <tr><td colspan="2"><textarea name="_cgiargtlcAttrsafe_::_1_" rows="_gtitextareaheight_" cols="_gtitextareawidth_">_4_</textarea></td></tr>
  </table>
</center>
}

# Links to see the translation files in action
_gtiviewcoredminaction_ {<a href="_gwcgi_?a=p&amp;p=about&amp;c=demo&amp;l=_cgiargtlcUrlsafe_&amp;e=_compressedoptions_">_textgtiviewtargetfileinaction_</a>}
_gtiviewauxdminaction_ {<a href="_gwcgi_?a=p&amp;p=about&amp;c=demo&amp;l=_cgiargtlcUrlsafe_&amp;e=_compressedoptions_">_textgtiviewtargetfileinaction_</a>}
