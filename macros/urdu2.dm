...
_textmustbelongtogroup_ [l=ur] {یاد رکھیے کہ آپ کو اس صفحہ تک رسائی کے لیے"_cgiargugHtmlsafe_" گروپ کا ممبر ہونا لازمی ہے}
...
_textdelinv_ [l=ur] {مجموعہ _cgiargbc1dirnameHtmlsafe_ محفوظ شدہ حالت میں ہے۔ اس لیے ڈیلیٹ نہیں کیا جا سکتا}

_textdelsuc_ [l=ur] {مجموعہ _cgiargbc1dirnameHtmlsafe_ کامیابی سے ڈیلیٹ ہو گیا ہے}
...
_textremwarn_ [l=ur] {کیا آپ حقیقتا <b>_cgiargumunHtmlsafe_</b>? کو مکمل طور پر ختم کرنا چاہتے ہیں؟}
