...
_textdescrlogout_ [l=pt-pt] {Sair como _cgiargunHtmlsafe_}  
...
_linktextLOGGEDIN_ [l=pt-pt] {(aceder como_cgiargunHtmlsafe_)}  
...
# any matches
_textquerytitle_ [l=pt-pt] {_If_(_thislast_,resultados _thisfirst_ - _thislast_ para a pesquisa: _cgiargqHtmlsafe_,Nunhuma resposta encontrada: _cgiargqHtmlsafe_)}
