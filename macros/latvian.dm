...
# any matches
_textquerytitle_ [l=lv] {_If_(_thislast_,rezultāti _thisfirst_ - _thislast_ priekš pieprasījuma: _cgiargqHtmlsafe_,Nav rezultātu priekš pieprasījuma: _cgiargqHtmlsafe_)}
