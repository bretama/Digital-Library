...
<p> თქვენს მიერ არჩეული ბმული არის გარე  "_collectionname_" კოლექციისთვის
   (ის მიუთითებს "_2_" კოლექციაზე).
    ...
    <a href="_httpdoc_&c=_1_&cl=_cgiargclUrlsafe_&d=_3_">აქ დააჭირეთ </a>ან გამოიყენეთ თქვენი ბრაუზერის 
...
<p> ბმული, რომელიც აირჩიეთ, არის გარე "_collectionname_"
   ...
   თუ გსურთ ამ ბმულის  "_2_" კოლექციაში ნახვა 
    <a href="_httpdoc_&c=_1_&cl=_cgiargclUrlsafe_&d=_3_">გადადით</a> ამ გვერდზე; 
...
_textmustbelongtogroup_ [l=ka] {თქვენ უნდა მიეკუთვნებოდეთ მომხმარებელთა "_cgiargugHtmlsafe_" ჯგუფს გვერდის სანახავად.}
...
<a href="_httppagex_(bsummary)&c=_cgiargbc1dirnameUrlsafe_" target=_top>შექმნის რეზიუმეში 
</a> .
}
...
_textdelperm_ [l=ka] {ყველა ან რამოდენიმე  _cgiargbc1dirnameHtmlsafe_ კოლექცია ვერ წაიშლება. . ეს შესაძლებელია შემდეგი მიზეზების გამო.:
<ul>
<li> გრინსტოუნს არ გააჩნია  _gsdlhome_/collect/_cgiargbc1dirnameHtmlsafe_
დირექტორიის წაშლის უფლება.<br>
შეგიძლიათ გადაიტანოთ ამ დირექტორიის ინსტრუქცია იმისთვის ,რომ _cgiargbc1dirnameHtmlsafe_
...
_textdelinv_ [l=ka] {კოლექცია _cgiargbc1dirnameHtmlsafe_ დაცულია ან არასწორია. წაშლა უარყოფილია.
}

_textdelsuc_ [l=ka] {კოლექცია _cgiargbc1dirnameHtmlsafe_ წარმატებულად წაიშალა.}

_textclonefail_ [l=ka] {კოლექციამ  _cgiargclonecolHtmlsafe_ ვერ უზრუნველყო აბსოლუტური  შეთავსება. <br> ეს შესაძლებელია შემდეგი მიზეზების გამო:<ul>
<li> კოლექცია _cgiargclonecolHtmlsafe_ არ არსებობს
<li> კოლექცია _cgiargclonecolHtmlsafe_ არ გააჩნია collect.cfg კონფიგურაციის ფაილი
...
_textexptsuc_ [l=ka] {კოლექცია_cgiargbc1dirnameHtmlsafe_ წარმატებულად გადაიგზავნა  
_gsdlhome_/tmp/exported__cgiargbc1dirnameHtmlsafe_ დირექტორიაში.
}

_textexptfail_ [l=ka] {<p> კოლექციის_cgiargbc1dirnameHtmlsafe_ დიერქტორიაში ეხსპორტის პრობლემა.
...
_textaboutpassword_ [l=ka] {პაროლის სიგრძე უნდა იყოს 3-8 სიმბოლო. იგი შეიძლება შეიცავდეს ჩვეულებრივ ASCII  სიმბოლოებს.
}
...
_textremwarn_ [l=ka] {ნამდვილად გსურთ საბოლოოდ მომხმარებელის წაშლა <b>_cgiargumunHtmlsafe_</b>?}
