...
_textdescrdeposit_ [l=fr] {Déposer un élément dans la collection}
_textdescrlogin_ [l=fr] {Page de connexion}
_textdescrlogout_ [l=fr] {Deconnexion de _cgiargunHtmlsafe_}
...
_linktextDEPOSIT_ [l=fr] {DÉPÔT}
_linktextLOGIN_ [l=fr] {LOGIN}
_linktextLOGGEDIN_ [l=fr] {(connecté comme _cgiargunHtmlsafe_)}
...
_textdescrgogreenstone_ [l=fr] {Vous informe sur le logiciel Greenstone et fournit des liens vers d'autres informations telles que des exemples de collections, des détails techniques et de la documentation.
}
...
_textdescrcollector_ [l=fr] {Vous aide à créer des collections en ligne. Ceci est antérieur à l’Interface Bibliothécaire et dans la plupart des cas, l'Interface Bibliothécaire devrait être utilisée à la place.&#10;}

package depositor

_textdepositor_ [l=fr] {Le Déposant}
_textdescrdepositor_ [l=fr] {Vous aide à ajouter en ligne des documents à des collections existantes, au lieu d’utiliser GLI. &#10;}

_textdepositorlocal_ [l=fr] {Démarrer un nouveau dépôt}
package gti
...
# any matches
_textquerytitle_ [l=fr] {_If_(_thislast_,resultats _thisfirst_ - _thislast_ pour la recherche: _cgiargqHtmlsafe_,Pas de documents contenant: _cgiargqHtmlsafe_)}
...
_textsortbynone_ [l=fr] {ordre de construction}
