...
_textdescrlogout_ [l=hy] {Դուրս եկ որպես _cgiargunHtmlsafe_}
...
_linktextLOGGEDIN_ [l=hy] {(մուտք է գւործել որպես _cgiargunHtmlsafe_)}
...
_textcommentusername_ [l=hy] {Օգտվողի անուն}
_textaddusercomment_ [l=hy] {Ավելացրու մեջբերում}
_textusercommentlogout_ [l=hy] {Դուրս գալ}
_textaddcomment_ [l=hy] {հաստատել մեջբերումը}
_textcommentsubmitted_ [l=hy] {Մեջբերումը հաստատվել է}
_textisempty_ [l=hy] {Մեջբերումը դատարկ էր։}
_textusercommentssection_ [l=hy] {Մեջբերումներ}
...
# any matches
_textquerytitle_ [l=hy] {_If_(_thislast_,results _thisfirst_ - _thislast_ հարցման համար: _cgiargqHtmlsafe_,Չկան համընկնումներ հարցմանը: _cgiargqHtmlsafe_)}
...
_textascending_ [l=hy] {աճող}
_textdescending_ [l=hy] {նվազող}
...
_textformcasefold_ [l=hy] {անտեսիր գործը}
_textformaccentfold_ [l=hy] {անտեսիր շեշտերը}
_textformstem_ [l=hy] {ցողուն}
...
#_textadvancedmgppsearch_ [l=hy] {Search in _indexselection__If_(_jselection_, associated with _jselection_)_If_(_gselection_, at _gselection_ level )_If_(_nselection_, in _nselection_ language), and display results in _formquerytypeadvancedselection_ order, for}

#_textadvancedlucenesearch_ [l=hy] {Search in _indexselection__If_(_jselection_, associated with _jselection_)_If_(_gselection_, at _gselection_ level )_If_(_nselection_, in _nselection_ language)_If_(_sfselection_,\,_allowformbreak_ sorting results by _sfselection_\,_sortorderselection_\,) for }
...
#_textformsimplesearch_ [l=hy] {Search _If_(_jselection_, in _jselection_)_If_(_gformselection_, at _gformselection_ level )_If_(_nselection_, in _nselection_ language)_If_(_sfselection_,\, sorting results by _sfselection_\, _sortorderselection_\,) for _formquerytypesimpleselection_ of }
...
#_textformadvancedsearchlucene_ [l=hy] {Search _If_(_jselection_, in _jselection_)_If_(_gformselection_, at _gformselection_ level )_If_(_nselection_, in _nselection_ language)_If_(_sfselection_,\, sorting results by _sfselection_\, _sortorderselection_\,) for }
